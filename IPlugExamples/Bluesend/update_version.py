...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright jo12bar, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/Bluesend-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Bluesend-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Bluesend-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Bluesend-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Bluesend-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Bluesend-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/Bluesend-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/Bluesend.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Bluesend.iss",inplace=1):
